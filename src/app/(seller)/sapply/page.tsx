            ...
            <ScrollReveal className="mb-8 p-6 bg-blue-500/10 border border-blue-500/30 rounded-2xl flex gap-3 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-600 mt-1">
                  Well notify you once your application is reviewed.
                </p>
              </div>
            </ScrollReveal>
                  ...
                  >
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-muted-foreground">
                        You have {user?.purchaseCount || 0}/5
                      </p>
                    </div>
                  </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Use Cloudinary or any image hosting service
                  </p>
                </div>
