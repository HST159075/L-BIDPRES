...
export const sellerService = {
  ...
  getApplicationStatus: () =>
    api.get<ApiResponse<SellerApplication>>("/seller/application-status").then(extractData<SellerApplication>),

  getMyListings: (page = 1, limit = 20) =>
    api.get("/listings/seller/mine", { params: { page, limit } }).then(extractPaginated<Listing>),
